...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // region 참조변수에 객체 할당
        btn1 = (Button) findViewById(R.id.showFragment01);
        btn2 = (Button) findViewById(R.id.showFragment02);
        linearLayout = (LinearLayout) findViewById(R.id.linearLayout_container);
