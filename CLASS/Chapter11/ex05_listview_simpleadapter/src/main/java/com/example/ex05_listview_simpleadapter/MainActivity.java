...
public class MainActivity extends AppCompatActivity {
    ...
    // 리스트뷰에 표시할 데이터
    int[] imgResIds = {R.drawable.kakao01, R.drawable.kakao02, R.drawable.kakao03, R.drawable.kakao04, R.drawable.kakao05
            , R.drawable.kakao06, R.drawable.kakao07, R.drawable.kakao08, R.drawable.kakao09};
